...
public:
    ...
    /**
     * @fn virtual uint16_t* LCD16bpp::copyFrameBufferRegionToMemory(const Rect& region);
     *
...
protected:
    ...
    /**
     * @fn virtual void LCD16bpp::drawTextureMapScanLine(const DrawingSurface& dest, const Gradients& gradients, const Edge* leftEdge, const Edge* rightEdge, const TextureSurface& texture, const Rect& absoluteRect, const Rect& dirtyAreaAbsolute, RenderingVariant renderVariant, uint8_t alpha, uint16_t subDivisionSize);
     *
