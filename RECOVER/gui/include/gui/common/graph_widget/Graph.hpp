...
#include <gui/common/graph_widget/GraphBelow.hpp>
#include <gui/common/graph_widget/GraphDots.hpp>
#include <gui/common/graph_widget/PainterVerticalAlpha.hpp>
...
public:
	...
	CWRUtil::Q5 WidgetX(int x) {
		return graphLine.widgetX(x);		
	}
