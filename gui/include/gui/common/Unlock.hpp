...
public:
	...
	virtual void SetClickEvent(GenericCallback< const Unlock &> & callback) { clickEvent = &callback; }
	virtual void SetSwipeEvent(GenericCallback< const Unlock &> & callback) { swipeEvent = &callback; }
