...
public:
	 ...
	 * Set enter callback
	 */
	void SetEnterCallback(GenericCallback<const CustomKeyboard&> &callback )
	{		
		enterEvent = &callback;
	}
private:

	GenericCallback< const CustomKeyboard &> *enterEvent;
     ...
     */
    static const uint8_t BUFFER_SIZE = 125;
     ...
     */
    TextArea modeBtnTextArea1;
	TextArea modeBtnTextArea2;
