...
private:		
	...
	touchgfx::TextAreaWithOneWildcard  TxtDoorSwitch;
	touchgfx::TextAreaWithOneWildcard  TxtStatus;
	touchgfx::TextAreaWithOneWildcard  TxtProgress;
	touchgfx::TextAreaWithOneWildcard  TxtAttempts;
	touchgfx::TextAreaWithOneWildcard  TxtErrorCount;
	touchgfx::TextAreaWithOneWildcard  TxtLastError;
	...
	touchgfx::Unicode::UnicodeChar TxtDoorSwitchBuffer[GENERIC_BUFFER_SIZE];
	...
	touchgfx::Unicode::UnicodeChar TxtErrorCountBuffer[GENERIC_BUFFER_SIZE];
	touchgfx::Unicode::UnicodeChar TxtLastErrorBuffer[GENERIC_BUFFER_SIZE];
