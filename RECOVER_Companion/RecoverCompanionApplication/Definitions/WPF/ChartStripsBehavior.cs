...
namespace FosterAndFreeman.RecoverCompanionApplication.Definitions.WPF
{
    ...
    public class ChartInfoStripsBehavior : DependencyObject
    {
        ...
        {
            GetAxes(out Axis xAxis, out Axis yAxis);
            ...
            foreach (InfoStrip strip in this.InfoStrips)
            {
                    ...
                    !double.IsInfinity(toAdd.StartX))
                {
                    ...
                    {
                        ContentTemplate = toAdd.StripTemplate,
                        Content = toAdd
                    };
    ...
    public class InfoStrip : DependencyObject, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty StartDateProperty = DependencyProperty.Register(
            "StartDate", typeof(DateTime), typeof(InfoStrip), new PropertyMetadata(new DateTime()));

        public static readonly DependencyProperty EndDateProperty = DependencyProperty.Register(
            "EndDate", typeof(DateTime), typeof(InfoStrip), new PropertyMetadata(new DateTime()));
        public string Label
        {
